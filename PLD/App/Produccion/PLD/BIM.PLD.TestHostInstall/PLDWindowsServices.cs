...
namespace BIM.PLD.TestHost
{
    partial class PLDWindowsServices : ServiceBase
    {
        ...
        public ServiceHost serviceHost3 = null;
        public ServiceHost serviceHost4 = null;
        public ServiceHost serviceHost5 = null;
        ...
        {
            if (serviceHost1 != null || serviceHost2 != null || serviceHost3 != null || serviceHost4 != null || serviceHost5 != null || serviceHost6 != null || serviceHost7 != null || serviceHost8 != null)
            {
                serviceHost1.Close();
                serviceHost2.Close();
                serviceHost3.Close();
            ...
            serviceHost3 = new ServiceHost(typeof(VerificadorPLDServices));
            serviceHost4 = new ServiceHost(typeof(ConfiguracionPLDServices));
            serviceHost5 = new ServiceHost(typeof(ServiceVerificardorPLD));

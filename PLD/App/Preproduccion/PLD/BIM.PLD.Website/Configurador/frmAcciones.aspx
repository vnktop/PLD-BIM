...
<asp:UpdatePanel ID="upMain" runat="server">
    <ContentTemplate>
        ...
        <asp:Panel ID="pnlPopupAccionRegistro" runat="server" Width="400px" HorizontalAlign="Center">
        ...
        <asp:Panel ID="pnlPopupAsignacionCorreo" runat="server" Width="800px" HorizontalAlign="Center">

...
<asp:UpdatePanel ID="upMain" runat="server">
    <ContentTemplate>
        ...
        <asp:Panel ID="pnlPopupAccionRegistro" runat="server" Width="300px" HorizontalAlign="Center">
    ...
    <asp:Panel ID="pnlPopupEliminarRegistro" runat="server" Width="320px" HorizontalAlign="Center" >
    ...
    <asp:Panel ID="pnlPopupEditarAgregarRegistro" runat="server" Width="400px" HorizontalAlign="Center" >

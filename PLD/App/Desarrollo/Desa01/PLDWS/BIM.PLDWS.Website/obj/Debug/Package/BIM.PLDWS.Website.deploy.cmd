...
set _DeploySetParametersFile=%RootPath%BIM.PLDWS.Website.SetParameters.xml
)
...
@rem ---------------------------------------------------------------------------------
if not exist "%RootPath%BIM.PLDWS.Website.zip" (
echo "%RootPath%BIM.PLDWS.Website.zip" does not exist. 
...
echo. "%MSDeployPath%\msdeploy.exe" -source:package='%RootPath%BIM.PLDWS.Website.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension %_MsDeployAdditionalFlags%
"%MSDeployPath%\msdeploy.exe" -source:package='%RootPath%BIM.PLDWS.Website.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension %_MsDeployAdditionalFlags%
) else (
echo. "%MSDeployPath%\msdeploy.exe" -source:package='%RootPath%BIM.PLDWS.Website.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension -setParamFile:"%RootPath%BIM.PLDWS.Website.SetParameters.xml" %_MsDeployAdditionalFlags%
"%MSDeployPath%\msdeploy.exe" -source:package='%RootPath%BIM.PLDWS.Website.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension -setParamFile:"%RootPath%BIM.PLDWS.Website.SetParameters.xml" %_MsDeployAdditionalFlags%
)
goto :eof
...
:usage
echo =========================================================
if not exist "%RootPath%BIM.PLDWS.Website.deploy-readme.txt" (
...
start notepad "%RootPath%BIM.PLDWS.Website.deploy-readme.txt"
)
echo =========================================================
goto :eof

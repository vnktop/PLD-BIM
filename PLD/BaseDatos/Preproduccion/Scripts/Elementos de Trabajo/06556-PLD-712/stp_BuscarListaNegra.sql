USE [dbPLD]
GO
/****** Object:  StoredProcedure [dbo].[stp_BuscarListaNegra]    Script Date: 07/11/2013 10:51:24 ******/
SET ANSI_NULLS ON
GO
...
=================================================================*/
ALTER PROCEDURE [dbo].[stp_BuscarListaNegra]
...
BEGIN  
       ...
       IF (       @vchPersonaIncidenciaNombre <> '' 
             ...
             BEGIN
             print 'opción 1'                 
                    SELECT  TM.VCHIDQEQ,                                  TM.VCHTIPOLISTA,       TT.intTipoTipificacionID,
                    ...
                    ORDER BY TM.vchTipoLista,TM.vchidqeq, TT.vchDescripcion ASC
             print @NOMBRE 
             END   
